...
* [**Lab BAF6**](06-add-copilot-api): Add Copilot Retrieval API Integration - Rely on content stored in SharePoint Online via Copilot Retrieval API to add RAG to the agent
