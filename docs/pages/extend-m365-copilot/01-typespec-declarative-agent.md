...
- In the project folder, create a new folder called **adaptiveCards** under the **appPackage** folder. Create a file `repair.json` in the **adaptiveCards** folder and paste the code snippet as is from below to the file. 
