<div class="cc-lab-toc msa-path">
  ...
  <div>
    <p>SharePoint エージェントを構築したい場合は、これらの ラボ を実行してください</p>
    <ul>
      <li><a href="/copilot-camp/ja/pages/make/sharepoint-agents/01-first-agent/">MSA1 - 最初の SharePoint エージェントを構築する</a></li>
