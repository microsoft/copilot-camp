...
/// All operations require the HR.Manage scope for authorization.
/// </summary>
[McpServerToolType]
internal class HRTools
{
    ...
    {
        Console.WriteLine($"[{DateTime.Now:yyyy-MM-dd HH:mm:ss}] MCP Tool Invoked: ListCandidates");
        
        // Validate that the user has the required HR.Manage scope
        await _authorizationService.EnsureScopeAsync(HRScopes.HRManage);
    ...
    {
        Console.WriteLine($"[{DateTime.Now:yyyy-MM-dd HH:mm:ss}] MCP Tool Invoked: AddCandidate (Email: {email})");
    ...
    {
        Console.WriteLine($"[{DateTime.Now:yyyy-MM-dd HH:mm:ss}] MCP Tool Invoked: UpdateCandidate (Email: {email})");
    ...
    {
        Console.WriteLine($"[{DateTime.Now:yyyy-MM-dd HH:mm:ss}] MCP Tool Invoked: RemoveCandidate (Email: {email})");
    ...
    {
        Console.WriteLine($"[{DateTime.Now:yyyy-MM-dd HH:mm:ss}] MCP Tool Invoked: SearchCandidates (SearchTerm: {searchTerm})");
